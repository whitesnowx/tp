...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullFaculty_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_MODULE, null, VALID_VENUE, VALID_TAGS, VALID_AVAILABILITIES, VALID_MEETING,
                VALID_FAVOURITE);
    ...
    public void toModelType_nullVenue_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_MODULE, VALID_FACULTY, null, VALID_TAGS, VALID_AVAILABILITIES, VALID_MEETING,
                VALID_FAVOURITE);
    ...
    public void toModelType_nullModule_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, null,
                VALID_FACULTY, VALID_VENUE, VALID_TAGS, VALID_AVAILABILITIES, VALID_MEETING,
                VALID_FAVOURITE);
    ...
    public void toModelType_invalidAvailabilities_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_MODULE, VALID_FACULTY, VALID_VENUE, VALID_TAGS, invalidAvailabilities,
                VALID_MEETING, VALID_FAVOURITE);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidMeetingDescription_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_MODULE, VALID_FACULTY, VALID_VENUE, VALID_TAGS, VALID_AVAILABILITIES,
                invalidMeeting, VALID_FAVOURITE);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidFavourite_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_MODULE, VALID_FACULTY, VALID_VENUE, VALID_TAGS, VALID_AVAILABILITIES,
                VALID_MEETING, INVALID_FAVOURITE);

...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withTags("friends").withAvailabilities("mon 12:00 14:00").withFavourite(false).build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withTags("owesMoney", "friends").withAvailabilities("tues 12:00 14:00", "wed 12:00 14:00")
            .withFavourite(true).build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz")
            .withPhone("95352563").withEmail("heinz@example.com").withModule("CS2030S")
            .withFaculty("Computing").withVenue("wall street").withFavourite(true).build();
    public static final Person CLARA = new PersonBuilder().withName("Clara Svarog")
            ...
            .withFaculty("Computing").withVenue("belobog avenue").withTags("classmate")
            .withAvailabilities("fri 12:00 14:00").withFavourite(true).build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier")
            ...
            .withTags("friends").withAvailabilities("thurs 12:00 14:00", "fri 12:00 14:00")
            .withFavourite(false).build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer")
            .withPhone("9482224").withEmail("werner@example.com").withModule("CS2100")
            .withFaculty("Computing").withVenue("michegan ave").withFavourite(false)
            .build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz")
            .withPhone("9482427").withEmail("lydia@example.com").withModule("CS2101")
            .withFaculty("Computing").withVenue("little tokyo").withFavourite(false).build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best")
            .withPhone("9482442").withEmail("anna@example.com").withModule("CS2102")
            .withFaculty("Computing").withVenue("4th street").withFavourite(false).build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withModule("CS2103").withFaculty("Computing")
            .withVenue("little india").withFavourite(false).build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withModule("CS2103T").withFaculty("Computing")
            .withVenue("chicago ave").withFavourite(false).build();
    ...
    public static final Person KAFKA = new PersonBuilder().withName("Kafka Apache").withPhone("9452413")
            ...
            .withVenue("pteruges avenue").withTags("classmate").withAvailabilities("FRIDAY 12:00 14:00")
            .withFavourite(false).build();
    public static final Person LEONARDO = new PersonBuilder().withName("Leonardo DiCaprio")
            .withPhone("88472234").withEmail("lcaprio@gmail.com").withModule("TS2237")
            .withFaculty("Arts and Social Sciences").withVenue("LT13").withFavourite(false).build();
    public static final Person MICHAEL = new PersonBuilder().withName("Michael Jackson")
            .withPhone("92347123").withEmail("heehee@gmail.com").withModule("MUA1163")
            .withFaculty("Music").withVenue("YSTCM-SR9").withFavourite(false).build();
    public static final Person NATASHA = new PersonBuilder().withName("Natasha Harrower")
            .withPhone("8019394").withEmail("harrower@example.com").withModule("CS2102")
            .withFaculty("Computing").withVenue("underworld avenue").withTags("classmate")
            .withAvailabilities("FRIDAY 12:00 14:00").withFavourite(false).build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withTags(VALID_TAG_FRIEND).withAvailabilities(VALID_AVAILABILITY_MON)
            .withFavourite(false).build();

    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    ...
                    new Venue("Blk 30 Geylang Street 29, #06-40"), getTagSet("professor"),
                    getAvailabilitySet("mon 12:00 13:00"), new Favourite(false)),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    new Module("CS1231S"), new Faculty("Computing"),
                    new Venue("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), getTagSet("tutor", "friends"),
                    getAvailabilitySet("tues 12:00 13:00", "wed 12:00 13:00"), new Favourite(false)),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                    new Module("CS2030S"), new Faculty("Computing"),
                    new Venue("Blk 11 Ang Mo Kio Street 74, #11-04"), getTagSet("professor"),
                    getAvailabilitySet("mon 12:00 13:00", "thurs 12:00 13:00"), new Favourite(false)),
            ...
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                    ...
                    new Venue("Blk 47 Tampines Street 20, #17-35"), getTagSet("tutor"),
                    getAvailabilitySet("mon 12:00 13:00", "tues 12:00 13:00", "thurs 12:00 13:00"),
                    new Favourite(false)),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                    new Module("CS2101"), new Faculty("Computing"),
                    new Venue("Blk 45 Aljunied Street 85, #11-31"), getTagSet("professor"),
                    getAvailabilitySet("sat 12:00 13:00", "mon 12:00 13:00",
                    "thurs 12:00 13:00"), new Favourite(false))
        };
    }

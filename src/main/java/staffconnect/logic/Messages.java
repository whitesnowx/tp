...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_INDEX =
            "The person index provided is invalid or person does not exist";
    public static final String MESSAGE_INVALID_MEETING_DISPLAYED_INDEX =
            "The meeting index provided is invalid or meeting does not exist";
